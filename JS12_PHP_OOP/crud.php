...
class Crud {
    ...
    public function read() {
        ...
        return $data;  // Corrected position
    }

    // Read By Id
    public function readById($id) {
        $query = "SELECT * FROM jabatan WHERE id = $id";  // Corrected column name
        $result = $this->db->conn->query($query);
    ...
    public function delete($id) {
        $query = "DELETE FROM jabatan WHERE id=$id";  // Corrected column name and variable
        $result = $this->db->conn->query($query);
